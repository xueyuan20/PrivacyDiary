package com.syalife.diary.ui.view;
...
import com.syalife.diary.ui.view.drawable.EditableDrawable;
import com.syalife.diary.ui.view.drawable.FeatherDrawable;
import com.imagezoom.ImageViewTouch;
import com.syalife.diary.util.Point2D;
import com.syalife.diary.util.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = DiaryApplication.getApp().getResources().getDrawable(R.mipmap.aviary_resize_knob, null);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = DiaryApplication.getApp().getResources().getDrawable(R.mipmap.aviary_delete_knob, null);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(DiaryApplication.getApp().dp2px(1));
