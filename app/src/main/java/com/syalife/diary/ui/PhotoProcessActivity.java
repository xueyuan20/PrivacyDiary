...
import com.syalife.diary.adapter.FilterAdapter;
import com.syalife.diary.adapter.StickerToolAdapter;
import com.syalife.diary.control.EffectService;
import com.syalife.diary.ui.view.LabelSelector;
import com.syalife.diary.ui.view.LabelView;
import com.syalife.diary.ui.view.MyHighlightView;
import com.syalife.diary.ui.view.MyImageViewDrawableOverlay;
import com.imagezoom.ImageViewTouch;
import com.syalife.diary.control.CameraManager;
import com.syalife.diary.effect.FilterEffect;
...
import com.syalife.diary.util.EffectUtil;
import com.syalife.diary.util.FileUtils;
import com.syalife.diary.util.GPUImageFilterTools;
import com.syalife.diary.util.ImageUtils;
import com.syalife.diary.util.StringUtils;
import com.syalife.diary.util.TimeUtils;
...
public class PhotoProcessActivity extends CameraBaseActivity {
    ...
    private void initView() {
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(DiaryApplication.getApp().getScreenWidth(),
                DiaryApplication.getApp().getScreenWidth());
        mImageView.setLayoutParams(params);
        overlay.setLayoutParams(params);
        drawArea.addView(overlay);
        //添加标签选择器
        RelativeLayout.LayoutParams rparams = new RelativeLayout.LayoutParams(DiaryApplication.getApp().getScreenWidth(), DiaryApplication.getApp().getScreenWidth());
    ...
    private boolean setCurrentBtn(TextView btn) {
        ...
        Drawable myImage = getResources().getDrawable(R.mipmap.select_icon, null);
